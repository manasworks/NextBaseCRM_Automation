...
public class TestBase {
    ...
    private static final String username4 = ConfigurationReader.getProperty("username4");
    private static final String username5 = ConfigurationReader.getProperty("username5");
    private static final String username6 = ConfigurationReader.getProperty("username6");
    private static final String username7 = ConfigurationReader.getProperty("username7");
    private static final String username8 = ConfigurationReader.getProperty("username8");
    private static final String username9 = ConfigurationReader.getProperty("username9");
