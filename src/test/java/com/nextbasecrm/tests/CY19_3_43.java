...
public class CY19_3_43 {
    ...
    public void verifying_log_out() {
        ...
        //verifying we relocated to the log in page
        //expected title of log in page "Authorization"
        String actualHomePageTitle = driver.getTitle();
        String expectedHomePageTitle= "Authorization";
